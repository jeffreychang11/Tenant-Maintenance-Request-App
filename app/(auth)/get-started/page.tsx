      ...
      {tenantOpen ? (
        <>
          ...
          <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center px-6 pb-10">
            ...
            <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400">
              Tenant accounts are set up by your landlord. Ask them to invite you — you&apos;ll get
              an email with an invite link. Already have one? Paste it below to get started.
            </p>
        ...
        <>
          ...
          <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-6 pb-10">
            <h1 className="text-2xl font-medium">Are you a landlord or a tenant?</h1>
